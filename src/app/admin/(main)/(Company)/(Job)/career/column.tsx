...
export type jobType = {
  ...
  phoneNumber: number
  email: string
  postion?: "Assistant Trek Leader" | "Social Media Handler" | "Trek Leader" | "Trek Coordinator" | "Content Team"
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="font-normal">
                ...
                <div className="flex"><p className="font-bold mr-1">Date Of Application	:</p>{row.getValue("dateOfApplication")}</div>
